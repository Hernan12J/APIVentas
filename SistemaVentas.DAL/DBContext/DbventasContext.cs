...
public partial class DbventasContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CFCF091D1");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F648FBAAA");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Men__C26AF4836B45CF4C");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A4EBFA83C1");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421A2A2FEBAD");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132631F3CC5");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76AF0F8FCF");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A66073D469");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614D0287D12");
